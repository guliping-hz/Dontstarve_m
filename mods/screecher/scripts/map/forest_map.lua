...
local function GenerateVoro(prefab, map_width, map_height, tasks, world_gen_choices, level_type, level)
	...
	-- SCARY_MOD: have to overwrite this whole file just to insert two lines below
	WorldSim:SetImpassibleTileType(GROUND.FOREST) -- make the tasks get "cut" using forest instead of impassible
	WorldSim:SeparateIslands()
	WorldSim:SetImpassibleTileType(defalt_impassible_tile) -- then set it back afterwards, just in case
	-- misspelled variable names/functions notwithstanding......
