...
local AmbientSoundMixer = Class(function(self, inst)
	...
	self.ambient_sounds =
	{
		...
		[GROUND.GRASS] = {sound = "scary_mod/amb/forest_sparce", wintersound = "dontstarve/winter/wintermeadowAMB", rainsound="dontstarve/rain/rainmeadowAMB"},
		[GROUND.FOREST] = {sound = "scary_mod/amb/forest_dense", wintersound = "dontstarve/winter/winterforestAMB", rainsound="dontstarve/rain/rainforestAMB"},
		...
		[GROUND.CHECKER] = {sound = "scary_mod/amb/forest_dead", wintersound = "dontstarve/winter/winterchessAMB", rainsound="dontstarve/rain/rainchessAMB"},
		[GROUND.CARPET] = {sound = "scary_mod/amb/campsite", wintersound = "dontstarve/winter/winterchessAMB", rainsound="dontstarve/rain/rainchessAMB"},
